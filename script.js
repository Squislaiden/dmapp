...
function EnemyAction() {
	...
	if (GSize == "Large" && RNG == 3) {reachX += 5} else if (GSize == "Huge") {reachX += 5} else if (GSize == "Gargantuan" && RNG == 3) {reachX += 15} else if (GSize == "Gargantuan" && RNG < 3) {reachX += 10} else {}
		...
		else if (RNG == 2) {GActionNames.push(`Ovipositor`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one target. Hit: The target is infested with 1d4 eggs, which immediately hatch into maggots. At the start of each of the target’s turns, the target takes ${Math.floor(GPB / 3)}d6 piercing damage per maggot infesting it. Applying fire to the bite wound before the end of the target’s next turn deals 1 fire damage to the target and kills these maggots. After this time, the maggots are too far under the skin to be burned. If a target infested by maggots ends its turn with 0 hit points, it dies as the maggots burrow into its heart and kill it. Any effect that cures disease kills all maggots infesting the target.`);}
		else if (RNG == 3) {GActionNames.push(`Bite`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 4) {GActionNames.push(`Dagger`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 5) {GActionNames.push(`Club`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) bludgeoning damage`);}
		else if (RNG == 6) {GActionNames.push(`Handaxe`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 7) {GActionNames.push(`Light Hammer`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 8) {GActionNames.push(`Javelin`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 9) {GActionNames.push(`Quarterstaff`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) bludgeoning damage or (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 10) {GActionNames.push(`Spear`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage or (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 11) {GActionNames.push(`Mace`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 12) {GActionNames.push(`Greatclub`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 13) {GActionNames.push(`Shortsword`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 14) {GActionNames.push(`Rapier`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 15) {GActionNames.push(`Longsword`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) slashing damage or (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 16) {GActionNames.push(`Whip`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 17) {GActionNames.push(`Battlaxe`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) slashing damage or (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 18) {GActionNames.push(`Morningstar`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 19) {GActionNames.push(`Flail`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 20) {GActionNames.push(`Warhammer`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) bludgeoning damage or (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 21) {GActionNames.push(`Pike`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 22) {GActionNames.push(`Barbed Whip`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 23) {GActionNames.push(`Halberd`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 24) {GActionNames.push(`Glaive`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 25) {GActionNames.push(`Greataxe`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d12 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 26) {GActionNames.push(`Greatsword`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil((GPB / 3) * 2)}d6 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 27) {GActionNames.push(`Maul`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil((GPB / 3) * 2)}d6 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 28) {GActionNames.push(`Scimitar`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 29) {GActionNames.push(`Trident`); GActions.push(`Melee or Ranged Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft. or range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage or (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) when held in one hand.`);}
		else if (RNG == 30) {GActionNames.push(`War Pick`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 31) {GActionNames.push(`Light Crossbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 8}/${(reachX + 5) * 32} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 32) {GActionNames.push(`Shortbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 8}/${(reachX + 5) * 32} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 33) {GActionNames.push(`Hand Crossbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 3}/${(reachX + 5) * 12} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 34) {GActionNames.push(`Heavy Crossbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 10}/${(reachX + 5) * 40} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 35) {GActionNames.push(`Longbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 15}/${(reachX + 5) * 60} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 36) {GActionNames.push(`Greatbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 25}/${(reachX + 5) * 100} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d12 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 37) {GActionNames.push(`Claw`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) slashing damage.`);}
		...
		else if (RNG == 41) {GActionNames.push(`Gemstone Eye of Flame`); GActions.push(`The creature shoots a magical eye ray, choosing one target it can see within 90 feet of it. The target must make a DC ${GTier + 12} Dexterity saving throw. On a failed save, the target takes ${Math.ceil(GPB / 3)}d8 fire damage, and if it is a creature or a flammable object, it ignites. On a successful save, the target takes half as much damage and does not ignite. A target that ignites takes ${Math.ceil(GPB / 3)}d6 fire damage at the start of each of its turns until a creature takes an action to douse the fire.`);}
		else if (RNG == 42) {GActionNames.push(`Rock`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 43) {GActionNames.push(`Dart`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) piercing damage.`);}
		...
		else if (RNG == 45) {GActionNames.push(`Needle Volley`); GActions.push(`The creature makes up to 1d6 needle attacks, but it cannot attack the same target more than twice during its turn. Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 46) {GActionNames.push(`Raking Vine`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage, and the target is grappled (escape DC ${GTier + 12}). Until this grapple ends, the target takes ${GPB * 2} piercing damage at the start of each of its turns. The creature has ${Math.floor(Math.random() * 3) + 1} raking vines, each of which can grapple only one target at a time.`);}
		else if (RNG == 47) {GActionNames.push(`Barbed Tail`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) piercing damage.`);}
		else if (RNG == 48) {GActionNames.push(`Scythe`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) slashing damage plus ${Math.ceil(GPB / 3)}d4 necrotic damage. Any creature reduced to 0 hit points by this attack dies, with its body and everything it is wearing and carrying, except magic items, exploding into a cloud of ash.`);}
		else if (RNG == 49) {GActionNames.push(`Entropic Touch`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) necrotic damage, and the target must succeed on a DC ${GTier + 12} Constitution saving throw or gain one level of exhaustion.`);}
		...
		else if (RNG == 52) {GActionNames.push(`Tentacle`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil((GPB / 3) * 2)}d6 + ${GWeaponMod}) bludgeoning damage. If the target is a creature, it is grappled (escape DC ${GTier + 12}). Until this grapple ends, the target is restrained. The creature can grapple no more than two targets at a time.`);}
		else if (RNG == 53) {GActionNames.push(`Fist`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 54) {GActionNames.push(`Acid Squirt`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 2}/${(reachX + 5) * 4} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) acid damage.`);}
		...
		else if (RNG == 60) {GActionNames.push(`Idyllic Touch`); GActions.push(`Melee Spell Attack: +${GSpellHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GSpellMod}) force damage. If the target is a creature, it must succeed on a DC ${GTier + 12} Wisdom saving throw or fall prone in a fit of laughter.`);}
		...
		else if (RNG == 62) {GActionNames.push(`Crysteel Dagger`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) piercing damage. plus ${Math.ceil(GPB / 3) + 2}d6 force damage`);}
		else if (RNG == 63) {GActionNames.push(`Strong Bite`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) piercing damage. If the target is a creature, it must succeed on a DC ${GTier + 12} Strength saving throw or take an extra ${Math.ceil(GPB / 3)}d6 piercing damage and be grappled (escape DC ${GTier + 12}). The creature can have only one creature grappled in this way at a time.`);}
		else if (RNG == 64) {GActionNames.push(`Arcane Blast`); GActions.push(`Ranged Spell Attack: +${GSpellHit} to hit, range 120 ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GSpellMod}) force damage.`);}
		else if (RNG == 65) {GActionNames.push(`Soul Binding`); GActions.push(`Melee Spell Attack: +${GSpellHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) necrotic damage. A creature reduced to 0 hit points from this attack dies and has its soul imprisoned inside the creature's body. The target can’t be revived by any means short of a wish spell until the creature is destroyed.`);}
		else if (RNG == 66) {GActionNames.push(`Paralyzing Claw`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) slashing damage plus ${Math.ceil(GPB / 3) + 2}d6 cold damage, and the target must succeed on a DC ${GTier + 12} Constitution saving throw or be paralyzed for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.`);}
		else if (RNG == 67) {GActionNames.push(`Holy Flail`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) bludgeoning damage plus ${Math.ceil(GPB / 2) + 2}d8 radiant damage.`);}
		else if (RNG == 68) {GActionNames.push(`Chromatic Orb`); GActions.push(`Ranged Spell Attack: +${GSpellHit} to hit, range 120 ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GSpellMod}) damage of a type chosen by the creature: acid, cold, fire, lightning, poison, or thunder.`);}
		else if (RNG == 69) {GActionNames.push(`Magic Staff`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d10 + ${GWeaponMod}) force damage.`);}
		...
		else if (RNG == 74) {GActionNames.push(`Talons`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) slashing damage.`);}
		else if (RNG == 75) {GActionNames.push(`Hooves`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil((GPB / 3) * 2)}d6 + ${GWeaponMod}) bludgeoning damage.`);}
		else if (RNG == 76) {GActionNames.push(`Slam`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d12 + ${GWeaponMod}) bludgeoning damage, and if the target if the same size or smaller than the creature, it can push the target ${reachX + 5} feet away from it.`);}
		else if (RNG == 77) {GActionNames.push(`Eldritch turret`); GActions.push(`Ranged Spell Attack: +${GSpellHit} to hit, range 300 ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GSpellMod}) force damage, and if the target is a creature, it is knocked prone.`);}
		else if (RNG == 78) {GActionNames.push(`Hammer of Justice`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) bludgeoning damage plus ${Math.ceil(GPB / 3)}d6 force damage. If the target is a creature, it must succeed on a DC ${GTier + 12} Strength saving throw or be knocked prone.`);}
...
The target’s hit point maximum is reduced by an amount equal to the necrotic damage taken, and the vampire regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0.`);}
		...
		else if (RNG == 85) {GActionNames.push(`Pseudopod`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX + 5} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d4 + ${GWeaponMod}) bludgeoning damage.`);}
		...
		else if (RNG == 95) {GActionNames.push(`Spit Fire`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 2}/${(reachX + 5) * 6} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) fire damage. If the target is a creature or a flammable object, it ignites. Until a creature takes an action to douse the fire, the target takes ${Math.ceil(GPB / 3)}d8 fire damage at the start of each of its turns.`);}
		...
		else if (RNG == 98) {GActionNames.push(`Gore`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage.`);}
		...
		else if (RNG == 101) {GActionNames.push(`Fiery Greatsword`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d6 + ${GWeaponMod}) slashing damage plus 16 (3d10) fire damage`);}
		else if (RNG == 102) {GActionNames.push(`Lightning Recolation`); GActions.push(`The creature teleports up to 60 feet to an unoccupied space it can see. When it does, it briefly transforms into a bolt of lightning, flashes upwards, then crashes down unharmed at its destination. Each enemy within 5 feet of the creature’s starting location or destination must succeed on a DC ${GTier + 12} Dexterity saving throw, taking ${Math.ceil(GPB / 2)}d6 lightning damage on a failed save, or half as much on a successful one. An enemy within 5 feet of both locations makes this saving throw only once.`);}
		...
		else if (RNG == 114) {GActionNames.push(`North Wind Longbow`); GActions.push(`Ranged Weapon Attack: +${GWeaponHit} to hit, range ${(reachX + 5) * 15}/${(reachX + 5) * 60} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) piercing damage plus ${Math.ceil(GPB / 3)}d8 cold damage`);}
		else if (RNG == 115) {GActionNames.push(`Wind Blast`); GActions.push(`Ranged Spell Attack: +${GSpellHit} to hit, range 50 ft., one creature. Hit: ${Math.ceil(GPB / 3)}d12 slashing damage.`);}
		else if (RNG == 116) {GActionNames.push(`Pincers`); GActions.push(`Melee Weapon Attack: +${GWeaponHit} to hit, reach ${reachX} ft., one creature. Hit: (${Math.ceil(GPB / 3)}d8 + ${GWeaponMod}) slashing damage. If the creature scores a critical hit against an enemy, roll a d10. On a 1-3, it severs the target’s arm, and on a 4-6 it severs the target’s leg. A creature missing an arm can’t wield weapons that require two hands, and if a creature is missing a leg, its speed is halved. Creatures without limbs are unaffected.`);}
...
function EnemyBonus() {
		...
		else if (RNG == 24) {GBonusNames.push(`Shield Wall (Recharge 4-6)`); GBonuses.push(`The creature adjusts its stance, moving shields and armor to encase its body. It regains ${GPB * 6} hp, and its AC increases by ${Math.ceil(GPB / 4) + 1} until the end of its next turn.`);}
		...
		else if (RNG == 30) {GBonusNames.push(`Vaporized Blood`); GBonuses.push(`A red mist surrounds the creature in a 20-foot-radius sphere. The mist spreads around corners, and its area is heavily obscured. It moves with the creature and doesn't impede the creature's vision. The mist dissipates after 1d4 + 1 rounds.`);}
